...
export const mountXiaohongshuPostDetailMonitor = createWeiboProfileMonitor({
  ...
  fieldKeys: ["postUrl", "noteId", "noteType", "title", "description", "author", "authorId", "authorUrl", "authorAvatar", "publishedAt", "ipLocation", "likes", "favorites", "comments", "shares", "topics", "cover", "imageUrls", "videoUrls", "capturedAt"],
  entityType: "content",
  contentType: "note",
  featureName: "小红书正文采集",
  rowLabel: "正文",
